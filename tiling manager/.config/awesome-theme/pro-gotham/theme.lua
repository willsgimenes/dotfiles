...
theme.layout_uselesstile            = theme.icons .. "/uselesstile.png"
theme.layout_uselesstileleft        = theme.icons .. "/uselesstileleft.png"
theme.layout_uselesstiletop         = theme.icons .. "/uselesstiletop.png"
